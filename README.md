...
4. Allow workflows to execute. 
  Click Action at the top bar, and confirm that you clearly understand the content of the workflows and so on.
  Because github doesn't allow workflows to be executed directly from the fork's repo.
